...
var _numberTransition = __webpack_require__(12);

var _numberTransition2 = _interopRequireDefault(_numberTransition);
...
(0, _numberTransition2.default)(1.22, 9000.333, function (val) {
	console.log(val);
});
...
exports.default = function (startValue, endValue, callbackFn) {
	var anime = function () {
			...
			return _regenerator2.default.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							_context.next = 2;
							return (0, _nextTick2.default)(duration / frequency);

						case 2:
							if (times < frequency) {
								currValue = fromValue + (toValue - fromValue) * times / frequency;
	...
	var fromValue = parseFloat(startValue);
	var toValue = parseFloat(endValue);
	if (fromValue == toValue) {
		return callbackFn(toValue);
	}
	var frequency = 20; // 变化频次
	var times = 1;
...
exports.default = function () {
  var cd = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  return new Promise(function (reslove) {
    return setTimeout(reslove, cd);
  });
};
